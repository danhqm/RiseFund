  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.logoContainer}>
        <Image
          source={require('../assets/images/RiseFund-Light.png')} // your RiseFund logo
          style={styles.logo}
          resizeMode="contain"
        />
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#F1FFF3', // background same as design
  ...
  signupButton: {
    width: '80%',
    backgroundColor: '#DFF7E2', // light background
    paddingVertical: 15,
    borderRadius: 25,
    alignItems: 'center',
    marginBottom: 10,
